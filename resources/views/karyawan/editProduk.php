...
<div class="content-container w-screen h-screen bg-black flex justify-center">
    ...
    <div class="tambahProduk w-[85%] ml-4 rounded-2xl md:mt-40 mt-48 mb-4 flex flex-col items-center">
        <p class="text-white text-center text-xl font-bold">Edit Produk</p>
        <form action="<?= urlpath('produk/edit') ?>" enctype="multipart/form-data" method="post" class="mt-10">
          ...
          <div class="flex items-center mb-4 mt-4">
              <input name="best-seller" id="best-seller" type="checkbox" value="1" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
              <label for="default-checkbox" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Best Seller</label>
          </div>
